...
import com.ylzinfo.model.his.mz.mzyy.bs.GetClinicCodeService;

public class GetClinicCodeAction extends BaseAction {
	...
	public String performe(SoapHead head, String requestXml)
		...
		return new GetClinicCodeService().GetClinicCode(srq);
	}

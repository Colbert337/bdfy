...
import com.ylzinfo.model.his.mz.mzyy.bs.DoLockSignalService;

public class DoLockSignalAction extends BaseAction {
	...
	public String performe(SoapHead head, String requestXml)
		...
		return new DoLockSignalService().DoLockSignal(srq);
	}

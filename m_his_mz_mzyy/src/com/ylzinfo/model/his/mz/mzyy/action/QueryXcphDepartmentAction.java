...
import com.ylzinfo.model.his.mz.mzyy.bs.QueryXcphDepartmentService;

public class QueryXcphDepartmentAction extends BaseAction{
	...
	public String performe(SoapHead head, String requestXml)throws SSTException {
		...
		return new QueryXcphDepartmentService().mainQueryBookDepartment(srq);
	}
}

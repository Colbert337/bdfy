...
import com.ylzinfo.model.his.mz.mzyy.bs.QueryXcphTimeService;

public class QueryXcphTimeAction extends BaseAction{
	...
	public String performe(SoapHead head, String requestXml)throws SSTException {
		...
		return new QueryXcphTimeService().mainQueryBookTime(srq);
	}
}

...
import com.ylzinfo.model.his.mz.yjjcz.service.ZfbpayChargeService;

public class ZfbpayFinishChargeAction extends BaseAction{
	...
	public String performe(SoapHead head, String requestXml)
		...
		return new ZfbpayChargeService().ZfbpayFinishCharge(srq);
	}
}

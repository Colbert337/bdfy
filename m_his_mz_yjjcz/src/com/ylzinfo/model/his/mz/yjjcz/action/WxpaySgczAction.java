...
import com.ylzinfo.model.his.mz.yjjcz.service.WxpayChargeService;

public class WxpaySgczAction extends BaseAction{
	...
	public String performe(SoapHead head, String requestXml)
		...
		param.put("iscz00", "1");
		return new WxpayChargeService().WxpayFinishCharge(param);
	}
}
